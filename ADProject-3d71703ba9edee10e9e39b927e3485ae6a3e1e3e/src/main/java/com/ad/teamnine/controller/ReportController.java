...
public class ReportController {
	...
	public String getReportRecipe(@PathVariable(value = "recipeId") Integer recipeId, Model model,
	...
	public String getReportMember(@PathVariable Integer memberId, Model model, HttpSession sessionObj) {
