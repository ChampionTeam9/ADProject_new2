...
public class Member extends User{
	...
	public boolean equals(Object obj) {
	    ...
	    return Objects.equals(this.getId(), other.getId()); // Assuming getId() returns the unique identifier of Member
	}

	@Override
	public int hashCode() {
	    return Objects.hash(this.getId()); // Assuming getId() returns the unique identifier of Member
	}
